...
const FEATURES = [
  ...
  { icon: "📝", title: "Smart Notes", desc: "Full markdown notes editor with auto-save, toolbar, and word count. Pre-filled with video structure." },
...
const STEPS = [
  { step: "01", title: "Paste URL", desc: "Copy any YouTube video link and paste it into VidBrain. Select your output language." },
  { step: "02", title: "AI Analyzes", desc: "Our AI reads the real video metadata and generates a complete structured knowledge base in seconds." },
    ...
    <div style={{ fontFamily: "Syne, sans-serif", background: "#0d0d0f", color: "#f0efe8", overflowX: "hidden" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 860, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 18, color: "#9b9a96", maxWidth: 560, margin: "0 auto 20px", lineHeight: 1.7 }}>
            Paste any YouTube URL. Get instant summaries, flashcards, quizzes, mind maps, concept graphs, AI tutor, smart notes, community highlights and more — in 7 languages.
          </p>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 8, marginBottom: 36 }}>
            {["Summary", "Chapters", "Q&A", "Flashcards", "Mind Map", "Concept Graph", "Quiz", "AI Tutor", "Notes", "Community", "Podcast", "Read", "Chat"].map((f) => (
              <span key={f} style={{
                ...
                background: "#131316", border: "1px solid rgba(255,255,255,0.07)", color: "#5a5958",
              }}>{f}</span>
            ))}
          </div>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="#features"
              style={{
                ...
                color: "#9b9a96", textDecoration: "none", display: "inline-block",
              }}
          ...
          <p style={{ fontSize: 12, color: "#5a5958", marginTop: 20, fontFamily: "'DM Mono', monospace" }}>
      ...
      <section style={{ padding: "0 1.5rem 6rem" }}>
        <div style={{
          ...
          {STATS.map((s, i) => (
            <div key={i} style={{
              padding: "2rem 1rem", textAlign: "center", background: "#0d0d0f",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
            {STEPS.map((item, i) => (
              <div key={i} style={{
                ...
                <div style={{ position: "absolute", top: -10, right: -10, fontSize: 80, fontWeight: 800, color: "rgba(224,90,43,0.06)", lineHeight: 1 }}>
                  {item.step}
                </div>
      ...
      <section style={{ padding: "2rem 1.5rem 6rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{
            ...
            <div>
              <div style={{ fontSize: 11, fontWeight: 700, color: "#4a9eff", letterSpacing: "2px", textTransform: "uppercase", marginBottom: 12 }}>
                Unique Feature
              </div>
      ...
      <section style={{ padding: "2rem 1.5rem 6rem" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 15, color: "#9b9a96", marginBottom: 40, lineHeight: 1.7, maxWidth: 500, margin: "0 auto 40px" }}>
            Share your key insights from any video, see what others highlighted, and upvote the best learnings. Crowdsourced wisdom from the community.
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 500, margin: "0 auto" }}>
            {[
              ...
              <div key={i} style={{
                ...
                borderRadius: 14, background: "#131316", border: "1px solid rgba(255,255,255,0.07)",
                textAlign: "left",
              }}>
                <div style={{ width: 32, height: 32, borderRadius: 10, background: i === 0 ? "#e05a2b" : i === 1 ? "#4a9eff" : "#3cb87a", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 800, color: "white", flexShrink: 0 }}>
                  {i + 1}
                </div>
        ...
        <div style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ fontSize: 15, color: "#9b9a96", marginBottom: 16, lineHeight: 1.7 }}>
              Join thousands of students using VidBrain to study faster, retain more, and learn in their own language.
            </p>
            <p style={{ fontSize: 13, color: "#5a5958", marginBottom: 32, fontFamily: "'DM Mono', monospace" }}>
              13 features · 7 languages · No signup · Always free
            </p>
            <button onClick={onGetStarted}
              style={{
