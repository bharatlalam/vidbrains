...
export default function Header({ onLogoClick, onHistoryClick, onCompareClick, onDashboardClick, onCollectionsClick, onGroupsClick, showHistory, showCompare, showDashboard, showCollections, showGroups }) {
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between px-4 h-14 border-b"
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto">
        ...
        <span className="text-xs font-bold tracking-widest px-2 py-1 rounded-full uppercase hidden sm:block ml-1"
          style={{ background: "rgba(224,90,43,0.12)", color: "#f07040", border: "1px solid rgba(224,90,43,0.25)", letterSpacing: "1px", whiteSpace: "nowrap" }}>
          Beta
        </span>
      </div>
    </header>
